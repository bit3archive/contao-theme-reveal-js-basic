...
$GLOBALS['TL_DCA']['tl_article']['list']['label']['reveal_original_label_callback'] = $GLOBALS['TL_DCA']['tl_article']['list']['label']['label_callback'];
$GLOBALS['TL_DCA']['tl_article']['list']['label']['label_callback'] = array('Bit3\Contao\Theme\RevealJs\Basic\Hooks', 'getArticleLabel');
